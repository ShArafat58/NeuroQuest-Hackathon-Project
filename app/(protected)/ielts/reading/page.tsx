...
export default function IeltsReadingPage() {
    ...
    const loadPassage = async () => {
        ...
        setChecked(false);
        try {
            const res = await fetch("/api/ielts/reading-gen");
        ...
        <div className="flex min-h-screen flex-col bg-transparent">
            ...
            <main className="flex-1 container mx-auto px-4 py-8 max-w-3xl">
                <div className="mb-6 flex items-center justify-between">
                    ...
                    <button onClick={loadPassage} className="text-sm text-indigo-600 hover:underline">
                        New passage
                    </button>
                </div>
                ...
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h1 className="text-2xl font-extrabold text-slate-900">IELTS Reading Practice</h1>
                        <p className="text-slate-500 text-sm">Read the passage and answer the questions.</p>
                    </div>
                </div>
                ...
                {data && !loading && (
                    <>
                        ...
                        <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 mb-6">
                            <h2 className="font-bold text-slate-900 mb-3">{data.title}</h2>
