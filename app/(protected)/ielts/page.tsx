    ...
    <div className="flex min-h-screen flex-col bg-slate-50">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-5xl space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {/* Writing Card */}
          <Link href="/ielts/writing" className="block bg-white rounded-3xl p-8 border border-slate-200 shadow-sm hover:shadow-xl transition-all">
          ...
          {/* Reading Card */}
          <Link href="/ielts/reading" className="block bg-white rounded-3xl p-8 border border-slate-200 shadow-sm hover:shadow-xl transition-all">
            <div className="flex items-center mb-4">
          ...
          {/* Listening Card */}
          <Link href="/ielts/listening" className="block bg-white rounded-3xl p-8 border border-slate-200 shadow-sm hover:shadow-xl transition-all">
            <div className="flex items-center mb-4">
          ...
          {/* Speaking Card */}
          <div className="relative bg-white rounded-3xl p-8 border border-slate-200 shadow-sm opacity-60">
            <div className="flex items-center mb-4">
