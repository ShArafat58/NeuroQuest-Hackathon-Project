...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center p-6 overflow-hidden" style={{ background: "linear-gradient(120deg, #A8D4E8 0%, #C2E58A 100%)" }}>
      ...
      <div className="relative z-10 w-full max-w-md bg-white/80 backdrop-blur-md border border-white/60 p-8 rounded-2xl shadow-xl shadow-slate-900/10 flex flex-col items-center">
        {/* Brand Header */}
          ...
          <div className="w-full flex flex-col items-center">
            ...
            <form onSubmit={handleQuestionSubmit} className="space-y-4 w-full">
              ...
              <button
                ...
                className="w-full text-center text-xs text-slate-500 hover:text-slate-700 font-bold hover:underline mt-2 transition-all"
              >
        ...
        {step === "reset" && (
          ...
          <div className="w-full flex flex-col items-center">
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-4 w-full">
              {/* New Password */}
              <div className="space-y-1.5">
                <Label htmlFor="password" className="text-xs font-bold text-slate-700">New Password / নতুন পাসওয়ার্ড</Label>
                <div className="relative">
                  <Lock className="absolute left-3 top-3 w-4 h-4 text-slate-400" />
                  <Input
                    id="password"
              ...
              {/* Confirm Password */}
              <div className="space-y-1.5">
                <Label htmlFor="confirm_password" className="text-xs font-bold text-slate-700">Confirm New Password / পাসওয়ার্ড নিশ্চিত করুন</Label>
                <div className="relative">
                  <Lock className="absolute left-3 top-3 w-4 h-4 text-slate-400" />
                  <Input
                    id="confirm_password"
